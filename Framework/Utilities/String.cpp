...
string String::ToUpper(const string & lower)
{
	string upper;
...
string String::ToLower(const string & upper)
{
	string lower;
...
wstring String::ToUpper(const wstring & lower)
{
	return ToWString(ToUpper(ToString(lower)));
}

wstring String::ToLower(const wstring & upper)
{
	return ToWString(ToLower(ToString(upper)));
}
